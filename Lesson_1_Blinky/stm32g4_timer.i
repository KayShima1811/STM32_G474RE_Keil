...
void TIMx_Init(void);
# 10 "stm32g4_timer.c" 2

void ENABLE_CLOCK_TIM2_7(TIM_TypeDef* TIMx)
{
 uint32_t timer_pos = (((uint32_t)TIMx) & ((0x00001C00U))) >> 10;
 ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) |= ((0x00000001U) << timer_pos));
}
...
void TIMx_Setup(TIM_InitTypedef* TIMx)
{
 ...
 ((TIMx->Instance->PSC) |= (TIMx->Prescaler));


 (((TIMx->Instance->ARR)) = ((((((TIMx->Instance->ARR))) & (~((0xFFFFFFFFU)))) | (TIMx->Period))));




 ((TIMx->Instance->CR1) |= (TIMx->ClockDivision | TIMx->AutoReloadPreload | TIMx->CounterMode));


 ((TIMx->Instance->CR1) |= ((0x1UL << (0U))));
...
void TIMx_Init(void)
{
 TIM_InitTypedef TIMx_Config = {
  .Instance = ((TIM_TypeDef *) ((0x40000000UL) + 0x1000UL)),
  .Prescaler = 170-1,
  .Period = 0xffffffff,
  .AutoReloadPreload = (0x1UL << (7U)),
 };
