...
void ENABLE_CLOCK_PORT(GPIO_TypeDef* PORT_GPIO)
{
 uint32_t gpio_pos = ((((uint32_t)PORT_GPIO) & ((0x00001C00U))) >> 10);
 ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) |= ((0x00000001U) << gpio_pos));
}
...
void GPIO_Setup(GPIO_InitTypeDef *GPIOx)
{
 ...
 _Bool pin_afmode = Check_pin_afmode(GPIOx->Pin);
 ...
 switch (GPIOx->Mode) {
  case (0x00000000U):
   (((GPIOx->Port->MODER)) = ((((((GPIOx->Port->MODER))) & (~((0x00000003U) << positon))) | ((0x00000000U) << positon))));
   break;
  case (0x00000001U):
   (((GPIOx->Port->MODER)) = ((((((GPIOx->Port->MODER))) & (~((0x00000003U) << positon))) | ((0x00000001U) << positon))));
   break;
  case (0x00000002U):
   (((GPIOx->Port->MODER)) = ((((((GPIOx->Port->MODER))) & (~((0x00000003U) << positon))) | ((0x00000002U) << positon))));
   if(pin_afmode) {
    (((GPIOx->Port->AFR[0])) = ((((((GPIOx->Port->AFR[0]))) & (~((0x0000000FU)))) | (GPIOx->Alternate << (positon*2)))));
   }
   else {
    (((GPIOx->Port->AFR[1])) = ((((((GPIOx->Port->AFR[1]))) & (~((0x0000000FU)))) | (GPIOx->Alternate << (positon*2)))));
   }
   break;
  default:
   break;
 ...
 (((GPIOx->Port->PUPDR)) = ((((((GPIOx->Port->PUPDR))) & (~((0x00000003U) << positon))) | (GPIOx->Pull << positon))));
 (((GPIOx->Port->OSPEEDR)) = ((((((GPIOx->Port->OSPEEDR))) & (~((0x00000003U) << positon))) | ((0x00000003U) << positon))));
}
...
void GPIO_Init(void)
{
 ...
 GPIO_InitTypeDef GPIO_Config = {
  .Port = ((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)),
  .Pin = 5U,
  .Mode = (0x00000001U),
  .Pull = (0x00000000U),
  .Speed = (0x00000003U),
